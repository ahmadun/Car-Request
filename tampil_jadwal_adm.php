...
while($d = mysqli_fetch_array($data)){?>
	<tr>
		...
		<td><a href="edit_jadwal_adm.php?id=<?php echo $d['id']; ?>">Edit</a> / 
...
?>
	...
	<a href="tampil_jadwal_adm.php" type="button"  class="btn btn-info" > Tampil Jadwal </a></button>
	 <a href="add_jadwal_adm.php" type="button"  class="btn btn-secondary" > Tambah Jadwal </a></button><br><br>


 <script language="JavaScript" type="text/javascript">
      function del(id){
        if (confirm("yakin akan menghapus data ini?")){
          window.location.href = 'hapus_jadwal_adm.php?id=' + id;
        }
      }
 </script>
 </form>
